...
- **[Cyoda Cloud](/cyoda-cloud/)** — cyoda-go delivered as a managed
  service (coming soon). Isolated Postgres environments on the shared
  tier, with dedicated and Cassandra-backed enterprise tiers above.
  Right when you do not want to operate the infrastructure yourself.
